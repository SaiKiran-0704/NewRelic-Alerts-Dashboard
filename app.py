...
# --- PAGE SETUP ---
# Set initial_sidebar_state to "expanded" to ensure it's open on load
st.set_page_config(
...
with st.sidebar:
    ...
    with st.form("filter_form"):
        # Customer Selector - Default: "All Customers" (index 0)
        ...
        # Status Filter - Default: "All" (index 0)
        st.markdown("### Status")
        ...
        # Time Frame - Added "Last 6 Hours" and set as Default (index 1)
...
# --- 5. MAIN APP LOGIC ---
# Automatically fetch data on first load even if "Apply Filters" isn't clicked yet
...
if st.session_state['alert_data'].empty:
